...
const Drop=({type,drop})=>{
	...
	const {handleSubmit,searchOnClick,searchIndex,handleKeyDown,listRef,searchActive} = useGlobe()	
	return<div className={`${styles.searchdropDown} ${type.length === 0 && styles.hidden} ${drop.length === 0 && styles.hidden} ${!searchActive && styles.sm_drop_hidden}`}>
